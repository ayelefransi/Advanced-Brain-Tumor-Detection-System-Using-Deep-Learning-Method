...
function encryptClerkRequestData(requestData) {
  ...
  if (requestData.secretKey && !import_constants2.ENCRYPTION_KEY && (0, import_utils.isProductionEnvironment)()) {
  ...
  return import_aes.default.encrypt(JSON.stringify(requestData), maybeKeylessEncryptionKey).toString();
}
